...
export class TwelveComponent implements OnInit {
  ...
  countries = ['poland', 'czech', 'germany', 'ukraine', 'russia', 'lithuania'];
  drawn = [];
  repetitions = [];
  selectors = [];
  clickFieldId = null;
  ...
  newGame(): void {
    this.selectors = ['#one', '#two', '#three', '#four', '#five', '#six', '#seven', '#eight', '#nine', '#ten', '#eleven', '#twelve'];
